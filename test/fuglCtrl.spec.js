describe('fuglekontrolleren', function () {
  var $controller;

  beforeEach(module('finnFuglen'));
  ...
  //
  //     it('should calculate 6 * 5 = 30', function () {
  //       var ctrl = createController();
  //       ctrl.calculate(6, 5, operator);
  //
  //       expect(ctrl.result).toBe(30);
  //     });
  //   });
